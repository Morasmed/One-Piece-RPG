...
// LOGIKA ULEPSZANIA (NAPRAWIONA WERSJA!)
...
function handleResult(res) {
  ...
  // --- KIEROWANIE UCIECZKĄ ---
      ...
      if (res.label === "ESCAPED BARELY") {
          ...
          stepIndex = 15; // Przeżyłeś, wracasz na morze
      } else {
          characterState["Outcome"] = "KILLED";
          popupTitle = "Your journey ends here...";
          stepIndex = 25; // Złapany! Skok prosto do Final Fate (Krok 26 po stepIndex++)
      }
  }
  else {
